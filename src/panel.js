        ...
        div.innerHTML = `
                        <div class="channel-header-row">
                            ...
                            <button class="edit-server-btn" title="${t('editServer')}" tabindex="-1">
                                <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round"></g><g id="SVGRepo_iconCarrier"><path d="M12.146 2.146a1 1 0 0 1 1.415 1.415l-1.793 1.793-1.414-1.414 1.792-1.794ZM9.439 4.853 3 11.293V13h1.707l6.439-6.439-1.707-1.708Z" fill="#888"/></g></svg>
                            </button>
                            <button class="delete-server-btn" title="${t('deleteServer')}" tabindex="-1">
                                <svg height="16" width="16" viewBox="0 0 512 512"><path fill="#888" d="M256 22C132.3 22 32 122.3 32 246c0 123.7 100.3 224 224 224s224-100.3 224-224C480 122.3 379.7 22 256 22zm96 282.7L304.7 352 256 303.3 207.3 352 160 304.7 208.7 256 160 207.3 207.3 160 256 208.7 304.7 160l47.3 47.3L303.3 256 352 304.7z"/></svg>
                            </button>
                        </div>
